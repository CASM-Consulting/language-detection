 ...
 * load profiles with {@link DetectorFactorySingleton#loadProfile(String)} method
 * and set initialization parameters.
 * 
 * When the language detection,
 * construct Detector instance via {@link DetectorFactorySingleton#create()}.
 ...
 */
public class DetectorFactorySingleton {
    public HashMap<String, double[]> wordLangProbMap;
    public ArrayList<String> langlist;
    public Long seed = null;
    private DetectorFactorySingleton() {
        wordLangProbMap = new HashMap<String, double[]>();
        langlist = new ArrayList<String>();
    }
    static private DetectorFactorySingleton instance_ = new DetectorFactorySingleton();
